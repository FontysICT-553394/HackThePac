...
public class GhostHome : GhostBehavior
{
    ...
    {
        if (this.gameObject.activeSelf && Application.isPlaying && this.gameObject.scene.isLoaded)
        {
    ...
    /// <summary>
    /// A short routine where the Ghost leaves the Home through the hole at the top.
    /// </summary>
    /// <returns></returns>
